 ...
 * (see lib/admin.ts).
 */
// Argument order matches services/api.ts's withCache exactly, (key, ttlMs, loader),
// callback last, so the two same-named helpers can never be confused for one another.
