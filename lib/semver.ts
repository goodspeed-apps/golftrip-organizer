/**
 * GAS Template, Semver comparison utility (client-side)
 *
 * Mirrors the compareVersions logic from supabase/functions/_shared/semver.ts
 * for use in React Native / Node contexts.
 */
 ...
 *
 * Mirrors compareVersions in supabase/functions/_shared/semver.ts.
 */
