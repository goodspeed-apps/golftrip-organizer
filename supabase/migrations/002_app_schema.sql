...
drop policy if exists "trips_update_scoped" on public.trips;
drop policy if exists "trips_delete_scoped" on public.trips;
...
create policy "trips_update_scoped" on public.trips for update to authenticated using (trips.organizer_id = auth.uid() or exists (select 1 from public.trip_members m0 where m0.trip_id = trips.id and m0.user_id = auth.uid())) with check (trips.organizer_id = auth.uid() or exists (select 1 from public.trip_members m0 where m0.trip_id = trips.id and m0.user_id = auth.uid()));
create policy "trips_delete_scoped" on public.trips for delete to authenticated using (trips.organizer_id = auth.uid() or exists (select 1 from public.trip_members m0 where m0.trip_id = trips.id and m0.user_id = auth.uid()));
...
create policy "trip_members_update_own" on public.trip_members for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
...
drop policy if exists "tee_times_update_scoped" on public.tee_times;
drop policy if exists "tee_times_delete_scoped" on public.tee_times;
...
create policy "tee_times_update_scoped" on public.tee_times for update to authenticated using (tee_times.created_by = auth.uid() or exists (select 1 from public.rounds m0 where m0.tee_time_id = tee_times.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = tee_times.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid())))) with check (tee_times.created_by = auth.uid() or exists (select 1 from public.rounds m0 where m0.tee_time_id = tee_times.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = tee_times.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))));
create policy "tee_times_delete_scoped" on public.tee_times for delete to authenticated using (tee_times.created_by = auth.uid() or exists (select 1 from public.rounds m0 where m0.tee_time_id = tee_times.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = tee_times.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))));
...
create policy "expenses_update_scoped" on public.expenses for update to authenticated using (expenses.created_by = auth.uid() or exists (select 1 from public.trips m0 where m0.id = expenses.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid())))) with check (expenses.created_by = auth.uid() or exists (select 1 from public.trips m0 where m0.id = expenses.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))));
create policy "expenses_delete_scoped" on public.expenses for delete to authenticated using (expenses.created_by = auth.uid() or exists (select 1 from public.trips m0 where m0.id = expenses.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))));
...
drop policy if exists "expense_settlements_update_scoped" on public.expense_settlements;
drop policy if exists "expense_settlements_delete_scoped" on public.expense_settlements;
...
create policy "expense_settlements_update_scoped" on public.expense_settlements for update to authenticated using (exists (select 1 from public.trips m0 where m0.id = expense_settlements.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid())))) with check (exists (select 1 from public.trips m0 where m0.id = expense_settlements.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))));
create policy "expense_settlements_delete_scoped" on public.expense_settlements for delete to authenticated using (exists (select 1 from public.trips m0 where m0.id = expense_settlements.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))));
...
drop policy if exists "rounds_update_scoped" on public.rounds;
drop policy if exists "rounds_delete_scoped" on public.rounds;
...
create policy "rounds_update_scoped" on public.rounds for update to authenticated using (rounds.created_by = auth.uid() or exists (select 1 from public.scores m0 where m0.round_id = rounds.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = rounds.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))) or exists (select 1 from public.tee_times m3 where m3.id = rounds.tee_time_id and (m3.created_by = auth.uid() or exists (select 1 from public.rounds m4 where m4.tee_time_id = m3.id and m4.created_by = auth.uid()) or exists (select 1 from public.trips m5 where m5.id = m3.trip_id and (m5.organizer_id = auth.uid() or exists (select 1 from public.trip_members m6 where m6.trip_id = m5.id and m6.user_id = auth.uid())))))) with check (rounds.created_by = auth.uid() or exists (select 1 from public.scores m0 where m0.round_id = rounds.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = rounds.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))) or exists (select 1 from public.tee_times m3 where m3.id = rounds.tee_time_id and (m3.created_by = auth.uid() or exists (select 1 from public.rounds m4 where m4.tee_time_id = m3.id and m4.created_by = auth.uid()) or exists (select 1 from public.trips m5 where m5.id = m3.trip_id and (m5.organizer_id = auth.uid() or exists (select 1 from public.trip_members m6 where m6.trip_id = m5.id and m6.user_id = auth.uid()))))));
create policy "rounds_delete_scoped" on public.rounds for delete to authenticated using (rounds.created_by = auth.uid() or exists (select 1 from public.scores m0 where m0.round_id = rounds.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = rounds.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))) or exists (select 1 from public.tee_times m3 where m3.id = rounds.tee_time_id and (m3.created_by = auth.uid() or exists (select 1 from public.rounds m4 where m4.tee_time_id = m3.id and m4.created_by = auth.uid()) or exists (select 1 from public.trips m5 where m5.id = m3.trip_id and (m5.organizer_id = auth.uid() or exists (select 1 from public.trip_members m6 where m6.trip_id = m5.id and m6.user_id = auth.uid()))))));
...
drop policy if exists "scores_update_scoped" on public.scores;
drop policy if exists "scores_delete_scoped" on public.scores;
...
create policy "scores_update_scoped" on public.scores for update to authenticated using (scores.created_by = auth.uid() or exists (select 1 from public.rounds m0 where m0.id = scores.round_id and (m0.created_by = auth.uid() or exists (select 1 from public.scores m1 where m1.round_id = m0.id and m1.created_by = auth.uid()) or exists (select 1 from public.trips m2 where m2.id = m0.trip_id and (m2.organizer_id = auth.uid() or exists (select 1 from public.trip_members m3 where m3.trip_id = m2.id and m3.user_id = auth.uid()))) or exists (select 1 from public.tee_times m4 where m4.id = m0.tee_time_id and (m4.created_by = auth.uid() or exists (select 1 from public.rounds m5 where m5.tee_time_id = m4.id and m5.created_by = auth.uid()) or exists (select 1 from public.trips m6 where m6.id = m4.trip_id and (m6.organizer_id = auth.uid() or exists (select 1 from public.trip_members m7 where m7.trip_id = m6.id and m7.user_id = auth.uid()))))))) or exists (select 1 from public.trips m8 where m8.id = scores.trip_id and (m8.organizer_id = auth.uid() or exists (select 1 from public.trip_members m9 where m9.trip_id = m8.id and m9.user_id = auth.uid())))) with check (scores.created_by = auth.uid() or exists (select 1 from public.rounds m0 where m0.id = scores.round_id and (m0.created_by = auth.uid() or exists (select 1 from public.scores m1 where m1.round_id = m0.id and m1.created_by = auth.uid()) or exists (select 1 from public.trips m2 where m2.id = m0.trip_id and (m2.organizer_id = auth.uid() or exists (select 1 from public.trip_members m3 where m3.trip_id = m2.id and m3.user_id = auth.uid()))) or exists (select 1 from public.tee_times m4 where m4.id = m0.tee_time_id and (m4.created_by = auth.uid() or exists (select 1 from public.rounds m5 where m5.tee_time_id = m4.id and m5.created_by = auth.uid()) or exists (select 1 from public.trips m6 where m6.id = m4.trip_id and (m6.organizer_id = auth.uid() or exists (select 1 from public.trip_members m7 where m7.trip_id = m6.id and m7.user_id = auth.uid()))))))) or exists (select 1 from public.trips m8 where m8.id = scores.trip_id and (m8.organizer_id = auth.uid() or exists (select 1 from public.trip_members m9 where m9.trip_id = m8.id and m9.user_id = auth.uid()))));
create policy "scores_delete_scoped" on public.scores for delete to authenticated using (scores.created_by = auth.uid() or exists (select 1 from public.rounds m0 where m0.id = scores.round_id and (m0.created_by = auth.uid() or exists (select 1 from public.scores m1 where m1.round_id = m0.id and m1.created_by = auth.uid()) or exists (select 1 from public.trips m2 where m2.id = m0.trip_id and (m2.organizer_id = auth.uid() or exists (select 1 from public.trip_members m3 where m3.trip_id = m2.id and m3.user_id = auth.uid()))) or exists (select 1 from public.tee_times m4 where m4.id = m0.tee_time_id and (m4.created_by = auth.uid() or exists (select 1 from public.rounds m5 where m5.tee_time_id = m4.id and m5.created_by = auth.uid()) or exists (select 1 from public.trips m6 where m6.id = m4.trip_id and (m6.organizer_id = auth.uid() or exists (select 1 from public.trip_members m7 where m7.trip_id = m6.id and m7.user_id = auth.uid()))))))) or exists (select 1 from public.trips m8 where m8.id = scores.trip_id and (m8.organizer_id = auth.uid() or exists (select 1 from public.trip_members m9 where m9.trip_id = m8.id and m9.user_id = auth.uid()))));
...
create policy "messages_update_scoped" on public.messages for update to authenticated using (exists (select 1 from public.announcements m0 where m0.message_id = messages.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = messages.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid())))) with check (exists (select 1 from public.announcements m0 where m0.message_id = messages.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = messages.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))));
create policy "messages_delete_scoped" on public.messages for delete to authenticated using (exists (select 1 from public.announcements m0 where m0.message_id = messages.id and m0.created_by = auth.uid()) or exists (select 1 from public.trips m1 where m1.id = messages.trip_id and (m1.organizer_id = auth.uid() or exists (select 1 from public.trip_members m2 where m2.trip_id = m1.id and m2.user_id = auth.uid()))));
...
create policy "announcements_update_scoped" on public.announcements for update to authenticated using (announcements.created_by = auth.uid() or exists (select 1 from public.trips m0 where m0.id = announcements.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))) or exists (select 1 from public.messages m2 where m2.id = announcements.message_id and (exists (select 1 from public.announcements m3 where m3.message_id = m2.id and m3.created_by = auth.uid()) or exists (select 1 from public.trips m4 where m4.id = m2.trip_id and (m4.organizer_id = auth.uid() or exists (select 1 from public.trip_members m5 where m5.trip_id = m4.id and m5.user_id = auth.uid())))))) with check (announcements.created_by = auth.uid() or exists (select 1 from public.trips m0 where m0.id = announcements.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))) or exists (select 1 from public.messages m2 where m2.id = announcements.message_id and (exists (select 1 from public.announcements m3 where m3.message_id = m2.id and m3.created_by = auth.uid()) or exists (select 1 from public.trips m4 where m4.id = m2.trip_id and (m4.organizer_id = auth.uid() or exists (select 1 from public.trip_members m5 where m5.trip_id = m4.id and m5.user_id = auth.uid()))))));
create policy "announcements_delete_scoped" on public.announcements for delete to authenticated using (announcements.created_by = auth.uid() or exists (select 1 from public.trips m0 where m0.id = announcements.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))) or exists (select 1 from public.messages m2 where m2.id = announcements.message_id and (exists (select 1 from public.announcements m3 where m3.message_id = m2.id and m3.created_by = auth.uid()) or exists (select 1 from public.trips m4 where m4.id = m2.trip_id and (m4.organizer_id = auth.uid() or exists (select 1 from public.trip_members m5 where m5.trip_id = m4.id and m5.user_id = auth.uid()))))));
...
drop policy if exists "email_imports_update_scoped" on public.email_imports;
drop policy if exists "email_imports_delete_scoped" on public.email_imports;
...
create policy "email_imports_update_scoped" on public.email_imports for update to authenticated using (exists (select 1 from public.trips m0 where m0.id = email_imports.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))) or exists (select 1 from public.tee_times m2 where m2.id = email_imports.tee_time_id and (m2.created_by = auth.uid() or exists (select 1 from public.rounds m3 where m3.tee_time_id = m2.id and m3.created_by = auth.uid()) or exists (select 1 from public.trips m4 where m4.id = m2.trip_id and (m4.organizer_id = auth.uid() or exists (select 1 from public.trip_members m5 where m5.trip_id = m4.id and m5.user_id = auth.uid())))))) with check (exists (select 1 from public.trips m0 where m0.id = email_imports.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))) or exists (select 1 from public.tee_times m2 where m2.id = email_imports.tee_time_id and (m2.created_by = auth.uid() or exists (select 1 from public.rounds m3 where m3.tee_time_id = m2.id and m3.created_by = auth.uid()) or exists (select 1 from public.trips m4 where m4.id = m2.trip_id and (m4.organizer_id = auth.uid() or exists (select 1 from public.trip_members m5 where m5.trip_id = m4.id and m5.user_id = auth.uid()))))));
create policy "email_imports_delete_scoped" on public.email_imports for delete to authenticated using (exists (select 1 from public.trips m0 where m0.id = email_imports.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))) or exists (select 1 from public.tee_times m2 where m2.id = email_imports.tee_time_id and (m2.created_by = auth.uid() or exists (select 1 from public.rounds m3 where m3.tee_time_id = m2.id and m3.created_by = auth.uid()) or exists (select 1 from public.trips m4 where m4.id = m2.trip_id and (m4.organizer_id = auth.uid() or exists (select 1 from public.trip_members m5 where m5.trip_id = m4.id and m5.user_id = auth.uid()))))));
...
drop policy if exists "trip_recaps_update_scoped" on public.trip_recaps;
drop policy if exists "trip_recaps_delete_scoped" on public.trip_recaps;
...
create policy "trip_recaps_update_scoped" on public.trip_recaps for update to authenticated using (exists (select 1 from public.trips m0 where m0.id = trip_recaps.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid())))) with check (exists (select 1 from public.trips m0 where m0.id = trip_recaps.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))));
create policy "trip_recaps_delete_scoped" on public.trip_recaps for delete to authenticated using (exists (select 1 from public.trips m0 where m0.id = trip_recaps.trip_id and (m0.organizer_id = auth.uid() or exists (select 1 from public.trip_members m1 where m1.trip_id = m0.id and m1.user_id = auth.uid()))));
...
create policy "offline_mutation_queue_update_own" on public.offline_mutation_queue for update using (auth.uid() = user_id) with check (auth.uid() = user_id);
