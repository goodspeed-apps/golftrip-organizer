    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }} edges={['top']}>
      <ScrollView contentContainerStyle={{ paddingBottom: 48 }}>
        ...
        >
          ...
          <Text style={{ color: colors.error, fontWeight: '600', fontSize: 15, flex: 1 }}>
            Sign Out
          </Text>
        </TouchableOpacity>
        ...
        >
          ...
          >
            <Trash2 size={18} color={colors.error + '80'} />
          </View>
          <Text style={{ color: colors.error + '80', fontWeight: '600', fontSize: 15, flex: 1 }}>
            Delete Account
          </Text>
        </TouchableOpacity>
