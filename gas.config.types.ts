...
//   - gas-template/gas.config.types.ts (mirrored verbatim by the
//     sync-gas-template-types CI workflow; gas-template's gas.config.ts
//     imports from it).
//   - any other goodspeed-studio code that wants pure-TS named types
//     without pulling in zod at runtime.
//
