    ...
    <Modal visible={visible} transparent animationType="fade" onRequestClose={handleClose}>
      ...
      >
        ...
        >
          ...
          {/* Step content */}
          <Text style={{ color: colors.text, fontSize: 17, fontWeight: '700', marginBottom: 10, textAlign: 'center' }}>
            {step.title}
          </Text>
          ...
          <View style={{ flexDirection: 'row', gap: 10 }}>
            ...
            >
              <Text style={{ color: colors.textOnPrimary, fontSize: 15, fontWeight: '600' }}>
                {isLast ? 'Done' : 'Next'}
              </Text>
            </TouchableOpacity>
          </View>
