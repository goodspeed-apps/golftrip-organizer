      ...
      <View style={{ flex: 1, backgroundColor: colors.overlay, justifyContent: 'center', alignItems: 'center', padding: 24 }}>
        <View style={{ backgroundColor: surfaceDarkColor, borderRadius: 20, padding: 28, width: '100%', maxWidth: 400 }}>
          ...
          <View style={{ alignItems: 'center', marginBottom: 20 }}>
            <Icon size={64} color={step.iconColor} />
            {step.badge && (
              <View style={{ marginTop: 10, backgroundColor: color, borderRadius: 8, paddingHorizontal: 12, paddingVertical: 4 }}>
                <Text style={{ color: colors.textOnPrimary, fontSize: 12, fontWeight: '600' }}>{step.badge}</Text>
              </View>
            )}
          </View>
          ...
          <Text style={{ color: colors.textSecondary, fontSize: 14, textAlign: 'center', lineHeight: 21, marginBottom: 28 }}>{step.description}</Text>
