 ...
 * dark buttons.
 *
 * Note: Google and Microsoft use official brand colors that cannot be replaced
 * with semantic palette keys, they are not hex literals added by this codebase
 * but required brand marks. Only the monochrome providers (apple, x, linkedin)
 * use the `color` prop which callers supply from their theme.
 */
