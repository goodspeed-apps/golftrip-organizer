            ...
            {tiles.map((tile) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  accessibilityLabel={`Learn about ${tile.title}`}
                >
                  <View style={{
                    width: 48,
                    height: 48,
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={{ color: '#FFFFFF', fontSize: 16, fontWeight: '600', marginBottom: 4 }}>{tile.title}</Text>
                    <Text style={{ color: colors.textMuted, fontSize: 13 }}>{tile.description}</Text>
                  </View>
                </TouchableOpacity>
              );
            })}
