...
type Decision = 'accept_all' | 'reject_all' | 'customize' | 'not_required';
  ...
  return (
    <View style={{
      ...
      <View style={{ flexDirection: 'row', gap: 8, flexWrap: 'wrap' }}>
        <Pressable onPress={() => dismiss('accept_all')} style={btnPrimary}>
          <Text style={{ color: '#000' }}>Accept all</Text>
        </Pressable>
        <Pressable onPress={() => dismiss('reject_all')} style={btnSecondary}>
          <Text style={{ color: '#fff' }}>Reject non-essential</Text>
        </Pressable>
        <Pressable onPress={() => dismiss('customize')} style={btnSecondary}>
          <Text style={{ color: '#fff' }}>Customize</Text>
        </Pressable>
      </View>
    </View>
  );
